...
function draw() {
    ...
    if(gameState == "server" || gameState == "play") {
        paddle.render()
        paddle.update()
...
function paddleSelect() {
    ...
    image(arrows[1], 3 * VIRTUAL_WIDTH / 4-24, VIRTUAL_HEIGHT - VIRTUAL_HEIGHT / 3)
    tint(255)
...
function checkIfHighScore() {
    // add if fewer than 10 high score
...
//TODO : CAT SOUNDS - PURPLE CAT BRICK